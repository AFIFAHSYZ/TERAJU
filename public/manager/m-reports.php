...
$employees = $pdo->query("SELECT id, name  FROM users WHERE position != 'manager' ORDER BY name ASC")->fetchAll(PDO::FETCH_ASSOC);
...
<head>
<meta charset="UTF-8">
<title>Manager Leave Reports | Teraju LMS</title>
...
<div class="print-area" id="printArea">
  <div class="print-header">
    <h2>Teraju Construction — Leave Report</h2>
